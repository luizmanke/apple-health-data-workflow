...
func TestEveryAppleHealthSummaryColumnMustBeSentToQueue(t *testing.T) {
	...
	reader.ReadAppleHealthSummaryDataFromCSVFilesAndSendToQueue(
	...
	testkit.AssertEqual(
		...
		[]controller.Summary{appleHealthSummaryDataWithAllColumns()},
	)
}
...
func getSummaryMessagesFromQueue(t *testing.T, queueConfig queue.QueueConfig) []controller.Summary {
